      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-16 mt-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          >
            ...
            {/* Central Badge */}
            <div className="absolute bottom-6 left-6 right-6 md:right-auto bg-[var(--color-bz-bg)]/90 backdrop-blur border border-[var(--color-bz-border)] rounded-lg p-4 shadow-sm flex items-center gap-4">
